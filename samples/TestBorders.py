...
panelBG = Overlay(size=(500,500), color=Vec4(1,1,1,1))
...
txt = TextOverlay(msg="Hello!", font=fnt)
txt.reparentTo(panel)
x, y = widgets[1].getPos()
txt.setPos(x+5, y+5)

#or we can use padding to give the text some space
bord2 = LineBorder(color=Vec4(0.2,0.2,0.5,1))
bord2.reparentTo(panel)
txt.setBorder(bord2, padding=2)
